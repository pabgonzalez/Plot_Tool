...
" border-color: rgb(220, 220, 220);")
        ...
        self.numlabel.setGeometry(QtCore.QRect(315, 66, 241, 31))
        font = QtGui.QFont()
        ...
        self.denlabel.setGeometry(QtCore.QRect(315, 106, 241, 31))
        font = QtGui.QFont()
        font.setFamily("Cambria Math")
        font.setPointSize(10)
...
" border-color: rgb(220, 220, 220);")
        ...
        self.exportlabel = QtWidgets.QLabel(self.frameplotconfig)
        self.exportlabel.setGeometry(QtCore.QRect(300, 10, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setUnderline(True)
        self.exportlabel.setFont(font)
        self.exportlabel.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.pointslabel.setGeometry(QtCore.QRect(150, 30, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setUnderline(True)
        ...
        self.checkp1.setGeometry(QtCore.QRect(170, 50, 16, 23))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.checkp2.setGeometry(QtCore.QRect(170, 70, 16, 23))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.checkp3.setGeometry(QtCore.QRect(170, 90, 16, 23))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.checkp4.setGeometry(QtCore.QRect(170, 110, 16, 23))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.checkp5.setGeometry(QtCore.QRect(170, 130, 16, 23))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.originlabel.setGeometry(QtCore.QRect(210, 30, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setUnderline(True)
        ...
        self.origin1.setGeometry(QtCore.QRect(210, 50, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.origin2.setGeometry(QtCore.QRect(210, 70, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.origin3.setGeometry(QtCore.QRect(210, 90, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.origin4.setGeometry(QtCore.QRect(210, 110, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.origin5.setGeometry(QtCore.QRect(210, 130, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.origin5.setFont(font)
        self.origin5.setAlignment(QtCore.Qt.AlignCenter)
        self.origin5.setObjectName("origin5")
        self.filenameedit = QtWidgets.QLineEdit(self.frameplotconfig)
        self.filenameedit.setGeometry(QtCore.QRect(370, 10, 81, 20))
        self.filenameedit.setInputMethodHints(QtCore.Qt.ImhNone)
        self.filenameedit.setText("")
        self.filenameedit.setAlignment(QtCore.Qt.AlignCenter)
        self.filenameedit.setObjectName("filenameedit")
        self.resetview = QtWidgets.QPushButton(self.frameplotconfig)
        self.resetview.setGeometry(QtCore.QRect(300, 120, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.resetview.setFont(font)
        self.resetview.setStyleSheet("background-color: rgb(235, 235, 235);\n"
" border-style: solid;\n"
" border-width:5px;\n"
" border-color: rgb(220, 220, 220);")
        self.resetview.setAutoDefault(False)
        self.resetview.setDefault(False)
        self.resetview.setFlat(False)
        ...
        self.ampplot = QtWidgets.QStackedWidget(self.frameplot)
        self.ampplot.setGeometry(QtCore.QRect(10, 10, 561, 491))
        self.ampplot.setObjectName("ampplot")
        self.ampplotPage1 = QtWidgets.QWidget()
        self.ampplotPage1.setObjectName("ampplotPage1")
        self.ampplot.addWidget(self.ampplotPage1)
        self.phaseplot = QtWidgets.QStackedWidget(self.frameplot)
        self.phaseplot.setGeometry(QtCore.QRect(580, 10, 561, 491))
        self.phaseplot.setObjectName("phaseplot")
        self.phaseplotPage1 = QtWidgets.QWidget()
        self.phaseplotPage1.setObjectName("phaseplotPage1")
        self.phaseplot.addWidget(self.phaseplotPage1)
        self.frame = QtWidgets.QFrame(self.frameplot)
        self.frame.setGeometry(QtCore.QRect(1160, 10, 91, 491))
        self.frame.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setLineWidth(2)
        self.frame.setObjectName("frame")
        self.axrangelabel = QtWidgets.QLabel(self.frame)
        self.axrangelabel.setGeometry(QtCore.QRect(10, 10, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.axmin = QtWidgets.QLineEdit(self.frame)
        self.axmin.setGeometry(QtCore.QRect(10, 30, 41, 21))
        ...
        self.editaylabel = QtWidgets.QLineEdit(self.frame)
        self.editaylabel.setGeometry(QtCore.QRect(10, 330, 81, 20))
        self.editaylabel.setAlignment(QtCore.Qt.AlignCenter)
        self.editaylabel.setObjectName("editaylabel")
        self.editaxlabel = QtWidgets.QLineEdit(self.frame)
        self.editaxlabel.setGeometry(QtCore.QRect(10, 280, 81, 20))
        self.editaxlabel.setAlignment(QtCore.Qt.AlignCenter)
        self.editaxlabel.setObjectName("editaxlabel")
        self.fxlabel = QtWidgets.QLabel(self.frame)
        self.fxlabel.setGeometry(QtCore.QRect(10, 358, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        ...
        self.fxmin = QtWidgets.QLineEdit(self.frame)
        self.fxmin.setGeometry(QtCore.QRect(10, 130, 41, 21))
        self.fxmin.setInputMethodHints(QtCore.Qt.ImhFormattedNumbersOnly)
        self.fxmin.setAlignment(QtCore.Qt.AlignCenter)
        self.fxmin.setObjectName("fxmin")
        self.aylabel = QtWidgets.QLabel(self.frame)
        self.aylabel.setGeometry(QtCore.QRect(10, 308, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        ...
        self.fxrangelabel = QtWidgets.QLabel(self.frame)
        self.fxrangelabel.setGeometry(QtCore.QRect(10, 110, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        self.fxrangelabel.setFont(font)
        self.fxrangelabel.setAlignment(QtCore.Qt.AlignCenter)
        self.fxrangelabel.setObjectName("fxrangelabel")
        self.aymax = QtWidgets.QLineEdit(self.frame)
        self.aymax.setGeometry(QtCore.QRect(50, 80, 41, 21))
        ...
        self.ayrangelabel = QtWidgets.QLabel(self.frame)
        self.ayrangelabel.setGeometry(QtCore.QRect(10, 60, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        ...
        self.fyrangelabel = QtWidgets.QLabel(self.frame)
        self.fyrangelabel.setGeometry(QtCore.QRect(10, 160, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        ...
        self.fymax = QtWidgets.QLineEdit(self.frame)
        self.fymax.setGeometry(QtCore.QRect(50, 180, 41, 21))
        ...
        self.axlabel = QtWidgets.QLabel(self.frame)
        self.axlabel.setGeometry(QtCore.QRect(10, 258, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        ...
        self.axmax = QtWidgets.QLineEdit(self.frame)
        self.axmax.setGeometry(QtCore.QRect(50, 30, 41, 21))
        ...
        self.editfylabel = QtWidgets.QLineEdit(self.frame)
        self.editfylabel.setGeometry(QtCore.QRect(10, 430, 81, 20))
        self.editfylabel.setAlignment(QtCore.Qt.AlignCenter)
        self.editfylabel.setObjectName("editfylabel")
        self.fxmax = QtWidgets.QLineEdit(self.frame)
        self.fxmax.setGeometry(QtCore.QRect(50, 130, 41, 21))
        self.fxmax.setInputMethodHints(QtCore.Qt.ImhFormattedNumbersOnly)
        self.fxmax.setAlignment(QtCore.Qt.AlignCenter)
        self.fxmax.setObjectName("fxmax")
        self.editfxlabel = QtWidgets.QLineEdit(self.frame)
        self.editfxlabel.setGeometry(QtCore.QRect(10, 380, 81, 20))
        self.editfxlabel.setAlignment(QtCore.Qt.AlignCenter)
        self.editfxlabel.setObjectName("editfxlabel")
        self.fymin = QtWidgets.QLineEdit(self.frame)
        self.fymin.setGeometry(QtCore.QRect(10, 180, 41, 21))
        ...
        self.aymin = QtWidgets.QLineEdit(self.frame)
        self.aymin.setGeometry(QtCore.QRect(10, 80, 41, 21))
        ...
        self.fylabel = QtWidgets.QLabel(self.frame)
        self.fylabel.setGeometry(QtCore.QRect(10, 408, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        ...
        self.titlelabel.setGeometry(QtCore.QRect(10, 208, 81, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setUnderline(False)
        ...
        self.edittitle = QtWidgets.QLineEdit(self.frame)
        self.edittitle.setGeometry(QtCore.QRect(10, 230, 81, 20))
        ...
        self.updatebtn.setGeometry(QtCore.QRect(10, 460, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.updatebtn.setFont(font)
        self.updatebtn.setStyleSheet("background-color: rgb(235, 235, 235);\n"
" border-style: solid;\n"
" border-width:5px;\n"
" border-color: rgb(220, 220, 220);")
    ...
    def retranslateUi(self, PlotTool):
        ...
        self.numlabel.setText(_translate("PlotTool", "0"))
        ...
        self.denlabel.setText(_translate("PlotTool", "0"))
        ...
        self.saveamp.setText(_translate("PlotTool", "Exportar Amplitud"))
        self.savephase.setText(_translate("PlotTool", "Exportar Fase"))
        self.exportlabel.setText(_translate("PlotTool", "Archivo:"))
        ...
        self.origin1.setText(_translate("PlotTool", "Ecuación"))
        self.origin2.setText(_translate("PlotTool", "Ecuación"))
        self.origin3.setText(_translate("PlotTool", "Ecuación"))
        self.origin4.setText(_translate("PlotTool", "Ecuación"))
        self.origin5.setText(_translate("PlotTool", "Ecuación"))
        self.filenameedit.setPlaceholderText(_translate("PlotTool", "filename"))
        self.resetview.setText(_translate("PlotTool", "Reset"))
        self.axrangelabel.setText(_translate("PlotTool", "Amp. x range"))
        self.axmin.setText(_translate("PlotTool", "0"))
        self.editaylabel.setText(_translate("PlotTool", "| H(s) |"))
        self.editaxlabel.setText(_translate("PlotTool", "f [Hz]"))
        self.fxlabel.setText(_translate("PlotTool", "Fase x label"))
        self.fxmin.setText(_translate("PlotTool", "0"))
        self.aylabel.setText(_translate("PlotTool", "Amp. y label"))
        self.fxrangelabel.setText(_translate("PlotTool", "Fase x range"))
        self.aymax.setText(_translate("PlotTool", "1"))
        self.ayrangelabel.setText(_translate("PlotTool", "Amp. y range"))
        self.fyrangelabel.setText(_translate("PlotTool", "Fase y range"))
        self.fymax.setText(_translate("PlotTool", "1"))
        self.axlabel.setText(_translate("PlotTool", "Amp. x label"))
        self.axmax.setText(_translate("PlotTool", "1"))
        self.editfylabel.setText(_translate("PlotTool", "Grados"))
        self.fxmax.setText(_translate("PlotTool", "1"))
        self.editfxlabel.setText(_translate("PlotTool", "f [Hz]"))
        self.fymin.setText(_translate("PlotTool", "0"))
        self.aymin.setText(_translate("PlotTool", "0"))
        self.fylabel.setText(_translate("PlotTool", "Fase y label"))
        self.titlelabel.setText(_translate("PlotTool", "Título"))
        self.edittitle.setText(_translate("PlotTool", "f [Hz]"))
        self.updatebtn.setText(_translate("PlotTool", "Actualizar"))
